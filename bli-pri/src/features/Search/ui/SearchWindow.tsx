...
export const SearchWindow: FC = () => {
  ...
  return (
    <>
      <div className="w-[640px] bg-pop-up flex gap-[15px] rounded-[20px]">
        <svg className="mt-[17px] ml-[30px]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <input ref={refInput} onChange={e => setSearchText(e.target.value)} value={searchText} placeholder="Search..." className="w-[546px] h-[60px] outline-none bg-pop-up caret-yellow text-xl font-inter-regular text-white placeholder-grey" type="text" />
      </div>
