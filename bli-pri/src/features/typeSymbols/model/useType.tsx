...
//           controllerText.startPoint = drift.length - [...type].reverse().findIndex(item => item.content === ' ' && item.color === 'text-white') - 2;
//           console.log(controllerText.startPoint + 'Здесь меняется startPoint')
//         }
//         // else if (controllerText.deleteText > 0) {
//         //   setTimeout(() => {
//         //     console.log(type);
//         //     controllerText.startPoint = position - controllerText.startPoint;
//         //   }, 200)
//         //   // setTimeout(() => controllerText.startPoint = position - controllerText.startPoint + 1, 200);
//         // }
...
//     if (controllerText.deleteText == 2) {
//       console.log(controllerText.startPoint);
//       console.log(type);
//       drift.splice(0, controllerText.startPoint);
