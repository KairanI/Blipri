...
export const AudioInput: TypeAudioInput = ({ inputAudioRef, audio, setPlay }) => {
	return (
		<input
			...
			max='100'
			type="range"
			className="audio-line appearance-none w-[231px] h-[5px] max-tOne:max-w-[201px] max-tTwo:max-w-[171px] max-tTwo:max-h-[4px] rounded-[5px] cursor-pointer bg-black-grey outline-none"
			defaultValue={0}
