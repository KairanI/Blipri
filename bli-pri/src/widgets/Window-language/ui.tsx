...
import { FocusContext, TextContext } from "../../pages/Test/model/Context";
    ...
    return (
        <>
            ...
            {focusSettings?.activeModalSearch && (
                ...
                >
                    <div className="w-[640px] max-h-[800px] flex flex-col bg-pop-up rounded-[20px] fixed top-[110px]" onClick={e => e.stopPropagation()}>
                        <SearchWindow />
                    </div>
                </div>
            )}
