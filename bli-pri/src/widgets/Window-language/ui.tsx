...
export const WindowLanguage: FC = () => {
    ...
    return (
        <>
            <div className={`flex flex-row m-auto max-w-[170px] h-[35px] font-inter-regular text-lg text-grey flex-center-center gap-[12px] mt-[120px] tracking-[2px] group ${textSettings?.mode == 'dictation' ? '' : 'hover:text-white transition cursor-pointer'}`}
                onClick={() => {
